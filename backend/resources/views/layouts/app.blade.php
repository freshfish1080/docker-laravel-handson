...
<body>
    <div id="app">
        ...
        {{-- ３カラムに変更 --}}
        <main class="">
            <div class="row"> {{-- 1行目 今回は同じ行内に記述する --}}
                <div class="col-sm-12 col-md-2 p-0"> {{-- １列目 --}}
                    <div class="card">
                        <div class="card-header">タグ一覧</div>
                        <div class="card-body my-card-body">
                            <a href="/?tag=" class="card-text d-block mb-2">全て表示</a>
                    @foreach($tags as $tag)
                ...
                <div class="col-sm-12 col-md-4 p-0"> {{-- ２列目 --}}
                    <div class="card">
                ...
                <div class="col-sm-12 col-md-6 p-0"> {{-- ３列目 --}}
                    @yield('content')
                </div>
            </div>
        </main>
